      ...
      00E448                        422 	.ds 2
                                    ...
                                    459 ;------------------------------------------------------------
                                    460 ;	board/zbs29_BW_uc/../boardZBS29common.c:13: void powerPortsDownForSleep(void)
                                    461 ;	-----------------------------------------
      ...
      007961                        464 _powerPortsDownForSleep:
                           ...
                           000001   471 	ar1 = 0x01
                           000000   472 	ar0 = 0x00
                                    473 ;	board/zbs29_BW_uc/../boardZBS29common.c:15: P0FUNC = 0;
      007961 75 AD 00         [24]  474 	mov	_P0FUNC,#0x00
                                    475 ;	board/zbs29_BW_uc/../boardZBS29common.c:16: P1FUNC = 0;
      007964 75 AE 00         [24]  476 	mov	_P1FUNC,#0x00
                                    477 ;	board/zbs29_BW_uc/../boardZBS29common.c:17: P2FUNC = 0;
      007967 75 AF 00         [24]  478 	mov	_P2FUNC,#0x00
                                    479 ;	board/zbs29_BW_uc/../boardZBS29common.c:18: P0DIR = 0;
      00796A 75 B9 00         [24]  480 	mov	_P0DIR,#0x00
                                    481 ;	board/zbs29_BW_uc/../boardZBS29common.c:19: P0 = 0;
      00796D 75 80 00         [24]  482 	mov	_P0,#0x00
                                    483 ;	board/zbs29_BW_uc/../boardZBS29common.c:20: P0PULL = 0;
      007970 75 BC 00         [24]  484 	mov	_P0PULL,#0x00
                                    485 ;	board/zbs29_BW_uc/../boardZBS29common.c:21: P1DIR = 0;
      007973 75 BA 00         [24]  486 	mov	_P1DIR,#0x00
                                    487 ;	board/zbs29_BW_uc/../boardZBS29common.c:22: P1 = 2;
      007976 75 90 02         [24]  488 	mov	_P1,#0x02
                                    489 ;	board/zbs29_BW_uc/../boardZBS29common.c:23: P1PULL = 0;
      007979 75 BD 00         [24]  490 	mov	_P1PULL,#0x00
                                    491 ;	board/zbs29_BW_uc/../boardZBS29common.c:24: P2DIR = 2;
      00797C 75 BB 02         [24]  492 	mov	_P2DIR,#0x02
                                    493 ;	board/zbs29_BW_uc/../boardZBS29common.c:25: P2 =1;
      00797F 75 A0 01         [24]  494 	mov	_P2,#0x01
                                    495 ;	board/zbs29_BW_uc/../boardZBS29common.c:26: P2PULL = 0;
      007982 75 BE 00         [24]  496 	mov	_P2PULL,#0x00
                                    497 ;	board/zbs29_BW_uc/../boardZBS29common.c:27: }
      007985 22               [24]  498 	ret
                                    499 ;------------------------------------------------------------
                                    500 ;Allocation info for local variables in function 'boardInit'
                                    501 ;------------------------------------------------------------
                                    502 ;	board/zbs29_BW_uc/../boardZBS29common.c:29: void boardInit(void)
                                    503 ;	-----------------------------------------
                                    504 ;	 function boardInit
                                    505 ;	-----------------------------------------
      007986                        506 _boardInit:
                                    507 ;	board/zbs29_BW_uc/../boardZBS29common.c:32: P0FUNC |= (1 << 0) | (1 << 1) | (1 << 2) | (1 << 6);
      007986 43 AD 47         [24]  508 	orl	_P0FUNC,#0x47
                                    509 ;	board/zbs29_BW_uc/../boardZBS29common.c:33: P0DIR = (P0DIR &~ ((1 << 0) | (1 << 1) | (1 << 6))) | (1 << 2);
      ...
      00798F F5 B9            [12]  513 	mov	_P0DIR,a
                                    514 ;	board/zbs29_BW_uc/../boardZBS29common.c:36: P0PULL = (P0PULL &~ ((1 << 0) | (1 << 1) | (1 << 6))) | (1 << 2);
      ...
      007997 F5 BC            [12]  518 	mov	_P0PULL,a
                                    519 ;	board/zbs29_BW_uc/../boardZBS29common.c:39: P1FUNC &=~ ((1 << 1) | (1 << 2) | (1 << 7));
      007999 53 AE 79         [24]  520 	anl	_P1FUNC,#0x79
                                    521 ;	board/zbs29_BW_uc/../boardZBS29common.c:40: P1DIR &= ~((1 << 1) | (1 << 2) | (1 << 7));
      00799C 53 BA 79         [24]  522 	anl	_P1DIR,#0x79
                                    523 ;	board/zbs29_BW_uc/../boardZBS29common.c:43: P2FUNC &= ~((1 << 0) | (1 << 1) | (1 << 2));
      00799F 53 AF F8         [24]  524 	anl	_P2FUNC,#0xf8
                                    525 ;	board/zbs29_BW_uc/../boardZBS29common.c:44: P2DIR = (P2DIR &~ ((1 << 0) | (1 << 2))) | (1 << 1);
      ...
      0079A8 F5 BB            [12]  529 	mov	_P2DIR,a
                                    530 ;	board/zbs29_BW_uc/../boardZBS29common.c:47: P1_1 = 1;
                                    531 ;	assignBit
      0079AA D2 91            [12]  532 	setb	_P1_1
                                    533 ;	board/zbs29_BW_uc/../boardZBS29common.c:48: P1_7 = 1;
                                    534 ;	assignBit
      0079AC D2 97            [12]  535 	setb	_P1_7
                                    536 ;	board/zbs29_BW_uc/../boardZBS29common.c:51: P1_2 = 0;
                                    537 ;	assignBit
      0079AE C2 92            [12]  538 	clr	_P1_2
                                    539 ;	board/zbs29_BW_uc/../boardZBS29common.c:53: spiInit();
                                    540 ;	board/zbs29_BW_uc/../boardZBS29common.c:54: }
      0079B0 02 5B 57         [24]  541 	ljmp	_spiInit
                                    ...
                                    546 ;------------------------------------------------------------
                                    547 ;	board/zbs29_BW_uc/../boardZBS29common.c:57: __bit boardGetOwnMac(uint8_t __xdata *mac)
                                    548 ;	-----------------------------------------
      ...
      0079BD F0               [24]  558 	movx	@dptr,a
                                    559 ;	board/zbs29_BW_uc/../boardZBS29common.c:59: return flashRead(FLASH_INFOPAGE_ADDR + 0x10, mac, 8);
      ...
      007A4B                        646 	00099$:
                                    647 ;	board/zbs29_BW_uc/../boardZBS29common.c:136: }
                                    ...
                                    658 ;------------------------------------------------------------
                                    659 ;	board/zbs29_BW_uc/../boardZBS29common.c:138: void selfUpdate(void)
                                    660 ;	-----------------------------------------
      ...
      007A59 C0 00            [24]  671 	push	ar0
                                    672 ;	board/zbs29_BW_uc/../boardZBS29common.c:142: tempBuffer = malloc(320);
      ...
      007A6A 12 A2 3A         [24]  680 	lcall	_malloc
      ...
      007A7B D0 05            [24]  688 	pop	ar5
                                    689 ;	board/zbs29_BW_uc/../boardZBS29common.c:143: uint32_t updaterInfo = prvUpdateApplierGet();
      ...
      007A84 AC F0            [24]  693 	mov	r4,b
                                    694 ;	board/zbs29_BW_uc/../boardZBS29common.c:144: uint8_t __code *src = (uint8_t __code*)updaterInfo;
      007A86 8A 00            [24]  695 	mov	ar0,r2
      007A88 8B 01            [24]  696 	mov	ar1,r3
                                    697 ;	board/zbs29_BW_uc/../boardZBS29common.c:145: uint8_t i, len = updaterInfo >> 16;
      007A8A 8C 05            [24]  698 	mov	ar5,r4
                                    699 ;	board/zbs29_BW_uc/../boardZBS29common.c:147: if(!tempBuffer)wdtDeviceReset();
      ...
      007A90 12 59 AE         [24]  703 	lcall	_wdtDeviceReset
                                    704 ;	board/zbs29_BW_uc/../boardZBS29common.c:149: for (i = len; i ; i--)
      007A93                        705 00113$:
      ...
      007A9E 60 1E            [24]  713 	jz	00103$
                                    714 ;	board/zbs29_BW_uc/../boardZBS29common.c:150: *dst++ = *src++;
      ...
      007AB7 AA 83            [24]  730 	mov	r2,dph
                                    731 ;	board/zbs29_BW_uc/../boardZBS29common.c:149: for (i = len; i ; i--)
      007AB9 18               [12]  732 	dec	r0
      007ABA D0 05            [24]  733 	pop	ar5
      007ABC 80 DF            [24]  734 	sjmp	00107$
      007ABE                        735 00103$:
                                    736 ;	board/zbs29_BW_uc/../boardZBS29common.c:152: if (!flashWrite(0xfc00, tempBuffer, len, true))
      ...
      007AD9 40 0F            [24]  755 	jc	00105$
                                    756 ;	board/zbs29_BW_uc/../boardZBS29common.c:153: pr("failed to write updater\n");
      007ADB 74 31            [12]  757 	mov	a,#___str_0
      ...
      007AEA                        764 00105$:
                                    765 ;	board/zbs29_BW_uc/../boardZBS29common.c:155: IEN_EA = 0;	//ints off
                                    766 ;	assignBit
      007AEA C2 AF            [12]  767 	clr	_IEN_EA
                                    768 ;	board/zbs29_BW_uc/../boardZBS29common.c:161: );
      007AEC 90 FC 00         [24]  769 	mov	dptr, #0xfc00			
      007AEF E4               [12]  770 	clr	a						
      007AF0 73               [24]  771 	jmp	@a+dptr					
                                    772 ;	board/zbs29_BW_uc/../boardZBS29common.c:162: }
      ...
      007B01 22               [24]  781 	ret
                                    ...
                                    784 	.area CONST   (CODE)
      00B931                        785 ___str_0:
      00B931 66 61 69 6C 65 64 20   786 	.ascii "failed to write updater"
             74 6F 20 77 72 69 74
             65 20 75 70 64 61 74
             65 72
      00B948 0A                     787 	.db 0x0a
      00B949 00                     788 	.db 0x00
                                    789 	.area CSEG    (CODE)
                                    790 	.area XINIT   (CODE)
