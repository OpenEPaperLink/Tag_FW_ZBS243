...
;------------------------------------------------------------
;	board/zbs29_BW_uc/../boardZBS29common.c:13: void powerPortsDownForSleep(void)
;	-----------------------------------------
...
_powerPortsDownForSleep:
	...
	ar1 = 0x01
	ar0 = 0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:15: P0FUNC = 0;
	mov	_P0FUNC,#0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:16: P1FUNC = 0;
	mov	_P1FUNC,#0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:17: P2FUNC = 0;
	mov	_P2FUNC,#0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:18: P0DIR = 0;
	mov	_P0DIR,#0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:19: P0 = 0;
	mov	_P0,#0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:20: P0PULL = 0;
	mov	_P0PULL,#0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:21: P1DIR = 0;
	mov	_P1DIR,#0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:22: P1 = 2;
	mov	_P1,#0x02
;	board/zbs29_BW_uc/../boardZBS29common.c:23: P1PULL = 0;
	mov	_P1PULL,#0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:24: P2DIR = 2;
	mov	_P2DIR,#0x02
;	board/zbs29_BW_uc/../boardZBS29common.c:25: P2 =1;
	mov	_P2,#0x01
;	board/zbs29_BW_uc/../boardZBS29common.c:26: P2PULL = 0;
	mov	_P2PULL,#0x00
;	board/zbs29_BW_uc/../boardZBS29common.c:27: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'boardInit'
;------------------------------------------------------------
;	board/zbs29_BW_uc/../boardZBS29common.c:29: void boardInit(void)
;	-----------------------------------------
;	 function boardInit
;	-----------------------------------------
_boardInit:
;	board/zbs29_BW_uc/../boardZBS29common.c:32: P0FUNC |= (1 << 0) | (1 << 1) | (1 << 2) | (1 << 6);
	orl	_P0FUNC,#0x47
;	board/zbs29_BW_uc/../boardZBS29common.c:33: P0DIR = (P0DIR &~ ((1 << 0) | (1 << 1) | (1 << 6))) | (1 << 2);
	mov	a,#0xbc
	anl	a,_P0DIR
	orl	a,#0x04
	mov	_P0DIR,a
;	board/zbs29_BW_uc/../boardZBS29common.c:36: P0PULL = (P0PULL &~ ((1 << 0) | (1 << 1) | (1 << 6))) | (1 << 2);
	mov	a,#0xbc
	anl	a,_P0PULL
	orl	a,#0x04
	mov	_P0PULL,a
;	board/zbs29_BW_uc/../boardZBS29common.c:39: P1FUNC &=~ ((1 << 1) | (1 << 2) | (1 << 7));
	anl	_P1FUNC,#0x79
;	board/zbs29_BW_uc/../boardZBS29common.c:40: P1DIR &= ~((1 << 1) | (1 << 2) | (1 << 7));
	anl	_P1DIR,#0x79
;	board/zbs29_BW_uc/../boardZBS29common.c:43: P2FUNC &= ~((1 << 0) | (1 << 1) | (1 << 2));
	anl	_P2FUNC,#0xf8
;	board/zbs29_BW_uc/../boardZBS29common.c:44: P2DIR = (P2DIR &~ ((1 << 0) | (1 << 2))) | (1 << 1);
	mov	a,#0xfa
	anl	a,_P2DIR
	orl	a,#0x02
	mov	_P2DIR,a
;	board/zbs29_BW_uc/../boardZBS29common.c:47: P1_1 = 1;
;	assignBit
	setb	_P1_1
;	board/zbs29_BW_uc/../boardZBS29common.c:48: P1_7 = 1;
;	assignBit
	setb	_P1_7
;	board/zbs29_BW_uc/../boardZBS29common.c:51: P1_2 = 0;
;	assignBit
	clr	_P1_2
;	board/zbs29_BW_uc/../boardZBS29common.c:53: spiInit();
;	board/zbs29_BW_uc/../boardZBS29common.c:54: }
	ljmp	_spiInit
;------------------------------------------------------------
...
;------------------------------------------------------------
;	board/zbs29_BW_uc/../boardZBS29common.c:57: __bit boardGetOwnMac(uint8_t __xdata *mac)
;	-----------------------------------------
...
_boardGetOwnMac:
	...
	inc	dptr
	movx	@dptr,a
;	board/zbs29_BW_uc/../boardZBS29common.c:59: return flashRead(FLASH_INFOPAGE_ADDR + 0x10, mac, 8);
	mov	dptr,#_boardGetOwnMac_mac_65536_82
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
;	board/zbs29_BW_uc/../boardZBS29common.c:60: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'prvUpdateApplierGet'
;------------------------------------------------------------
;	board/zbs29_BW_uc/../boardZBS29common.c:63: static uint32_t prvUpdateApplierGet(void) __naked
;	-----------------------------------------
;	 function prvUpdateApplierGet
;	-----------------------------------------
_prvUpdateApplierGet:
;	naked function: no prologue.
;	board/zbs29_BW_uc/../boardZBS29common.c:135: );
	mov	  DPTR, #00098$			
	mov	  A, #00099$			
	clr	  C						
	subb	 A, DPL				
	...
	sjmp	 00090$				
	00099$:
;	board/zbs29_BW_uc/../boardZBS29common.c:136: }
...
;------------------------------------------------------------
;	board/zbs29_BW_uc/../boardZBS29common.c:138: void selfUpdate(void)
;	-----------------------------------------
;	 function selfUpdate
;	-----------------------------------------
_selfUpdate:
	...
	push	ar1
	push	ar0
;	board/zbs29_BW_uc/../boardZBS29common.c:142: tempBuffer = malloc(320);
	mov	dptr,#0x0140
	push	ar5
	push	ar4
	push	ar3
	...
	pop	ar4
	pop	ar5
;	board/zbs29_BW_uc/../boardZBS29common.c:143: uint32_t updaterInfo = prvUpdateApplierGet();
	lcall	_prvUpdateApplierGet
	mov	r2,dpl
	mov	r3,dph
	mov	r4,b
;	board/zbs29_BW_uc/../boardZBS29common.c:144: uint8_t __code *src = (uint8_t __code*)updaterInfo;
	mov	ar0,r2
	mov	ar1,r3
;	board/zbs29_BW_uc/../boardZBS29common.c:145: uint8_t i, len = updaterInfo >> 16;
	mov	ar5,r4
;	board/zbs29_BW_uc/../boardZBS29common.c:147: if(!tempBuffer)wdtDeviceReset();
	mov	a,r6
	orl	a,r7
	jnz	00113$
	lcall	_wdtDeviceReset
;	board/zbs29_BW_uc/../boardZBS29common.c:149: for (i = len; i ; i--)
00113$:
	mov	ar3,r0
	mov	ar4,r1
	mov	ar1,r6
...
00107$:
	mov	a,r0
	jz	00103$
;	board/zbs29_BW_uc/../boardZBS29common.c:150: *dst++ = *src++;
	push	ar5
	mov	dpl,r3
	mov	dph,r4
	clr	a
...
;	board/zbs29_BW_uc/../boardZBS29common.c:149: for (i = len; i ; i--)
	...
	sjmp	00107$
00103$:
;	board/zbs29_BW_uc/../boardZBS29common.c:152: if (!flashWrite(0xfc00, tempBuffer, len, true))
...
;	assignBit
	...
	lcall	_flashWrite
	jc	00105$
;	board/zbs29_BW_uc/../boardZBS29common.c:153: pr("failed to write updater\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
00105$:
;	board/zbs29_BW_uc/../boardZBS29common.c:155: IEN_EA = 0;	//ints off
;	assignBit
	clr	_IEN_EA
;	board/zbs29_BW_uc/../boardZBS29common.c:161: );
	mov	dptr, #0xfc00			
	clr	a						
	jmp	@a+dptr					
;	board/zbs29_BW_uc/../boardZBS29common.c:162: }
	pop	ar0
	pop	ar1
	pop	ar2
	pop	ar3
