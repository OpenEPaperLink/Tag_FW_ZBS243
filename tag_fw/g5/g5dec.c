...
int g5_decode_init(__xdata G5DECIMAGE *pImage, int iWidth, int iHeight, __xdata uint8_t *pData, int iDataSize) __reentrant
{
...
static void G5DrawLine(__xdata G5DECIMAGE *pPage, __xdata int16_t *pCurFlips, __xdata uint8_t *pOut)
{
    int x, len, run;
    uint8_t lBit, rBit, *p;
    int iStart = 0, xright = pPage->iWidth;
    __xdata uint8_t *pDest;
...
//
static void Decode_Begin(__xdata G5DECIMAGE *pPage) __reentrant
{
    int i, xsize;
    __xdata int16_t *CurFlips, *RefFlips;
...
//
static int DecodeLine(__xdata G5DECIMAGE *pPage) __reentrant
{
    signed int a0, a0_p, b1;
    __xdata int16_t *pCur, *pRef, *RefFlips, *CurFlips;
    int xsize, tot_run=0, tot_run1 = 0;
    int32_t sCode;
    uint32_t lBits;
    uint32_t ulBits, ulBitOff;
    __xdata uint8_t *pBuf/*, *pBufEnd*/;
...
//
int g5_decode_line(__xdata G5DECIMAGE *pPage, __xdata uint8_t *pOut) __reentrant
{
    int rc;
    __xdata uint8_t *pBufEnd;
    __xdata int16_t *t1;
