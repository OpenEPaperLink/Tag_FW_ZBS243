...
extern void dump(const __xdata uint8_t *a, const __xdata uint16_t l);
extern bool checkCRC(const __xdata void *p, const uint8_t len);
...
extern bool validateMD5(__xdata uint32_t addr, __xdata uint16_t len);
