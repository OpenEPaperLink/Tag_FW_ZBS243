...
#define FW_VERSION 0x002A          // version number
#define FW_VERSION_SUFFIX "-RSET"  // suffix, like -RC1 or whatever.
...
// #define DEBUGMD5                 // Debug the MD5 validation
...
// #define DEBUGSTACK               // do a regular check on stack headroom
...
#if defined(DEBUGSETTINGS) || defined(DEBUGG5) || defined(DEBUGMEMLEAKS) || defined(DEBUGMSG) || defined(DEBUGBLOCKS) || defined(DEBUGPROTO) || defined(DEBUGOTA) || defined(DEBUGNFC) || defined(DEBUGEPD) || defined(DEBUGMAIN) || defined(DEBUGEEPROM)
    #define ISDEBUGBUILD
#endif
